        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leave_AspNetUsers_ApproverID",
            ...
            migrationBuilder.InsertData(
                table: "LeaveType",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("0e0189fd-8113-42e4-9e8a-c82a41cf631f"), "Annual Leave" });

            migrationBuilder.InsertData(
                table: "LeaveType",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("25ede852-c021-4806-9737-d98587920bc4"), "Emergency Leave" });

            migrationBuilder.InsertData(
                table: "LeaveType",
                columns: new[] { "Id", "Name" },
                values: new object[] { new Guid("e6246713-77b9-454a-9d94-20e1230cce5b"), "Sick Leave" });
